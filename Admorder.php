...
{
	$q="select *from orderinfo";
	$result=mysqli_query($connection,$q);
	echo mysqli_error($connection);
	echo "<table border='2' cellspacing='2' cellpadding='10' align='center'>";
	echo "<tr><th>Order No</th><th>Order Date</th><th>Item Name</th><th>Amount</th><th>Status</th><th>Action</th></tr>";
	while($r=mysqli_fetch_assoc($result))
	{
		$id=$r['orderno'];
		echo "<tr><td>".$r['orderno']."</td><td>".$r['orderdate']."</td><td>".$r['pname']."</td><td>".$r['amount']."</td><td>".$r['status']."</td><td><a href='Admview.php?orderid=$id'>View</td></tr>";
	}
	echo "</table>";
}
