...
if(isset($_REQUEST['insert']))
{
	...
	move_uploaded_file($t,"cake/".$image);
	...
	{
		$query="insert into product(pname,flavour,weight,price,photo) values('$pname','$flavour','$weight',$price,'$image')";
...
<td class="aa"><a href="Admorder" class="bb">View Order</a></td>
<td class="aa"><a href="Admspecial.php" class="bb">Special Items</a></td>
<td class="aa"><a href="Admreport" class="bb">Report</a></td>
...
<h1><center>Cake Item Detail</center></h1>
<table align="center" cellpadding="10" cellspacing="10">
<tr><td>Product Name:</td><td><input type="text" name="pname" id ="pname"></td></tr>
<tr><td>Flavour:</td><td><input type="text" name="flavour" id ="flavour"></td></tr>
