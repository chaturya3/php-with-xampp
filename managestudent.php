  ...
  <li class="has-children">
					...
					<?php
						...
						echo "<table border='2' cellspacing='2' cellpadding='2'>
							<tr><td>Name</td><td>Gender</td>
							<td>Address</td><td>Phone</td>
							<td>Mail</td><td>parent Name</td>
								
							<td>Parent Contact</td>
							<td>Branch</td><td>Class</td>
							<td>Roll No</td>
							<td>Action</td></tr>";
						while($r=mysqli_fetch_assoc($res))
						{
							...
							echo "<td>".$r['email']."</td>";
							echo "<td>".$r['parent_name']."</td>";
							echo "<td>".$r['parent_ph']."</td>";
							echo "<td>".$r['branch']."</td>";
							echo "<td>".$r['class']."</td>";
							echo "<td>".$r['rollno']."</td>";
							echo "<td><a href='sdelete.php?ma=$em'>Delete</a></td>";
						}
					?>
              <!-- /.row -->
                            </div>
