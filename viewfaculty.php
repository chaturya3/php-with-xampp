                    ...
                    <div class="main-page">
                        ...
                        <section class="section">
							...
							<table border='2' cellspacing='10' cellpadding='10'>
								...
								$ma = $_SESSION['mail'];
								$q = "select * from faculty where mail='$ma'";
								...
								if($r=mysqli_fetch_assoc($res))
								{
									...
									echo "<td>Mail</td><td>".$r['mail']."</td></tr>";
									echo "<td>Password</td><td>".$r['pass']."</td></tr>";
									echo "<td>Contact</td><td>".$r['contact']."</td></tr>";
									echo "<td>Subject</td><td>".$r['subject']."</td></tr>";
									echo "<td>Joining Date</td><td>".$r['joining']."</td></tr>";
