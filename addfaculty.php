...
if(isset($_REQUEST['register']))
{
	...
	$sub=$_REQUEST['subjectdealing'];
	$jd=$_REQUEST['joiningdate'];
	...
	{
		$q="insert into faculty values('$name','$mail','$pass','$contact','$sub','$jd')";
...
<tr><td><center>ENTER TEACHER DETAILS</center></td></tr>
<tr><td><b>Teacher Name:</b></td><td><input type="text" name="tname" value="">
<tr><td><b>EmailID:</b></td><td><input type="text" name="mailid" value="">
<tr><td><b>Password:</b></td><td><input type="password" name="pass" value="">

<tr><td><b>Contact Number:</b></td><td><input type="text" name="contact" value="">

<tr><td><b>Subject Dealing:</b></td><td><input type="text" name="subjectdealing" value=""></td></tr>

<tr><td><b>Joining Date:</b></td><td><input type="text" name="joiningdate" value=""></td></tr></td>
</tr>
<tr>
<td>
