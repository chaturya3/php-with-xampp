  ...
  <li class="has-children">
					...
					<?php
						...
						echo "<table border='2' cellspacing='2' cellpadding='2'>
							<tr><td>Faculty Name</td><td>Mail</td><td>Password</td>
							<td>Contact</td><td>Subject</td><td>Joining Date</td>
							<td>Action</td></tr>";
						while($r=mysqli_fetch_assoc($res))
						{
							...
							echo "<td>".$r['joining']."</td>";
							echo "<td><a href='fdelete.php?ma=$em'>Delete</a></td>";
						}
					?>
              <!-- /.row -->
                            </div>
